 ...
 *
 */
public class MNISTSingleLayerOwnDataSetKurs {

    public static final String MODEL_PATH = "/home/tom/tmp/MATHEMA-Campus-2024/DeepLearning4j/models/";
    public static final String MODEL_PREFIX = "MNISTSingleLayer";
    public static final String MODEL_POSTFIX = "model.dl4j";
    private static Logger log = LoggerFactory.getLogger(MNISTSingleLayerOwnDataSetKurs.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        log.info(eval.stats());
        model.save(new File(buildModelFullPath()));
//        MultiLayerNetwork.load(new File("dfdf.zip"), false);
        log.info("****************Example finished********************");

        long endTime = System.currentTimeMillis();
        long executionTime = endTime - startTime;
        double seconds = executionTime / 1000.0;
        System.out.println("The program took " + seconds + " to execute.");
        long minutes = (long)(seconds / 60);
        long remainingSeconds = (long)(seconds % 60);
        System.out.println("This is " + minutes + " minutes and " + remainingSeconds + " seconds.");
    }

    private static String buildModelFullPath() {
        LocalDateTime ldt = LocalDateTime.now();
        return  MODEL_PATH + "/" +
                MODEL_PREFIX + "." +
                ldt.format(DateTimeFormatter.ofPattern("yyyy-MM-dd_HH-mm-ss")) + "." +
                MODEL_POSTFIX;
    }
